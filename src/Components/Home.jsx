...
const Home = () => {
          ...
          match: [
            {
              matchInfo: {
                ...
                state: "Upcoming",
                status: "Match starts at May 04, 10:00 GMT",
                team1: {
                  teamId: 63,
                  teamName: "Kolkata Knight Riders",
                  teamSName: "KKR",
          ...
          match: [
            {
              matchInfo: {
                ...
                matchFormat: "T20",
                startDate: "1746799200000",
                endDate: "1746811800000",
                state: "Upcoming",
          ...
          match: [
            {
              matchInfo: {
                ...
                matchFormat: "T20",
                startDate: "1746885600000",
                endDate: "1746898200000",
                state: "Upcoming",
          ...
          match: [
            {
              matchInfo: {
                ...
                matchFormat: "T20",
                startDate: "1746957600000",
                endDate: "1746970200000",
                state: "Upcoming",
                team1: {
                  teamId: 65,
                  teamName: "Punjab Kings",
            ...
            },
            {
              matchInfo: {
                ...
                matchFormat: "T20",
                startDate: "1746972000000",
                endDate: "1746984600000",
                state: "Upcoming",
                team1: {
                  teamId: 61,
                  teamName: "Delhi Capitals",
          ...
          match: [
            {
              matchInfo: {
                ...
                matchFormat: "T20",
                startDate: "1747058400000",
                endDate: "1747071000000",
                state: "Upcoming",
          ...
          match: [
            {
              matchInfo: {
                ...
                matchFormat: "T20",
                startDate: "1747144800000",
                endDate: "1747157400000",
                state: "Upcoming",
          ...
          match: [
            {
              matchInfo: {
                ...
                matchFormat: "T20",
                startDate: "1747231200000",
                endDate: "1747243800000",
                state: "Upcoming",
          ...
          match: [
            {
              matchInfo: {
                ...
                matchFormat: "T20",
                startDate: "1747317600000",
                endDate: "1747330200000",
                state: "Upcoming",
          ...
          match: [
            {
              matchInfo: {
                ...
                matchFormat: "T20",
                startDate: "1747404000000",
                endDate: "1747416600000",
                state: "Upcoming",
  ...
  let filterData = data.matchDetails.filter(
    (everyMatch) => everyMatch.matchDetailsMap
  );
      ...
      {matchData.map(({ matchDetailsMap: { match, key: date } }, i) =>
        match.map(
          (
            ...
            <Link className="w-[50%] h-[95px] lg:h-[130px]" to={`/matchDetails/${matchId}`}>
              {/* <h1 key={i}>{team1Name} VS {teamSName}, {date} {status}</h1>   */}
              <div className=" w-full bg-gray-500 border p-3 flex flex-col gap-2">
                <div className="flex justify-between">
                  <p className="text-[10px] lg:text-[16px]"> {matchDesc}</p>
                  <p className="text-[10px] lg:text-[16px]">{date.split(2025)[0]}</p>
                </div>
                <div>
                  <div className="flex justify-between">
                    <div className="flex gap-5">
                      <img
                        className="w-2 lg:w-4 object-contain"
                        src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/${team1Img}`}
                        alt=""
                      />
                      <p className="text-[10px] lg:text-[16px]">{team1Name}</p>
                    </div>
                  ...
                  <div className="flex justify-between">
                    <div className="flex gap-5">
                      <img
                        ...
                        alt=""
                      />
                      <p className="text-[10px] lg:text-[16px]">{team2Name}</p>
                    </div>
